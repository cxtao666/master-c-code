...
{
	const char szWindowClass[] = "vffdvfvWindowClass";
	const char szWindowTitle[] = "vffdvfv";
	...
	wcex.hIcon = LoadIcon(hInstance, (LPCTSTR)IDI_VFFDVFV);
	wcex.hCursor = LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground = 0;
	wcex.lpszMenuName = (LPCSTR)IDC_VFFDVFV;
